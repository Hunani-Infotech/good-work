...
export default function GerozDecorShapes({ className = '' }) {
  return (
    <div
      className={`relative h-full min-h-(--spacing-screen-2-media) max-lg:mb-0 max-lg:flex max-lg:min-h-0 max-lg:h-auto max-lg:items-center max-lg:justify-center max-lg:gap-8 ${className}`.trim()}
      aria-hidden="true"
    >
      <img
