...
import TidalCopperTopBar from './TidalCopperTopBar.jsx';
import SharePreviewBanner from '../ui/SharePreviewBanner.jsx';
import CustomCursor from '../ui/CustomCursor.jsx';
import { useSite } from '../../context/SiteContext.jsx';
import { resetDocumentScrollState } from '../../animations/scrollRuntime.js';

export default function TidalCopperLayout({ children }) {
  const { site } = useSite();
